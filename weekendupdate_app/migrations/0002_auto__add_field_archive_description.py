...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archive.description'
        db.add_column('weekendupdate_app_archive', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archive.description'
        db.delete_column('weekendupdate_app_archive', 'description')
