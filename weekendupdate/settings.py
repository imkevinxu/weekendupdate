# Django settings for weekendupdate project.
...
SECRET_KEY = 'Z=y[)7]/Ovk<$&DD%5zdAK`\7#i9f@P5%o[AvJT#Z|^kn.).Qt'
...
ROOT_URLCONF = 'weekendupdate.urls'

WSGI_APPLICATION = 'weekendupdate.wsgi.application'
